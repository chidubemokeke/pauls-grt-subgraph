...
export class GNS__getLegacySubgraphKeyResult {
  value0: Address;
  value1: BigInt;
...
export class GNS__legacySubgraphDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: Bytes;
  value3: BigInt;
...
export class GNS__legacySubgraphKeysResult {
  value0: Address;
  value1: BigInt;
...
export class GNS__subgraphL2TransferDataResult {
  value0: BigInt;
  value1: boolean;
  value2: BigInt;
...
export class GNS__subgraphsResult {
  value0: BigInt;
  value1: BigInt;
  value2: Bytes;
  value3: BigInt;
...
export class GNS extends ethereum.SmartContract {
  ...
  getLegacySubgraphKey(_subgraphID: BigInt): GNS__getLegacySubgraphKeyResult {
    let result = super.call(
    ...
    return new GNS__getLegacySubgraphKeyResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_getLegacySubgraphKey(
    _subgraphID: BigInt
  ): ethereum.CallResult<GNS__getLegacySubgraphKeyResult> {
    let result = super.tryCall(
      "getLegacySubgraphKey",
      "getLegacySubgraphKey(uint256):(address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(_subgraphID)]
    ...
    return ethereum.CallResult.fromValue(
      new GNS__getLegacySubgraphKeyResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  legacySubgraphData(
    ...
    return new GNS__legacySubgraphDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBytes(),
      result[3].toBigInt(),
  ...
  try_legacySubgraphData(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<GNS__legacySubgraphDataResult> {
    let result = super.tryCall(
      "legacySubgraphData",
      "legacySubgraphData(address,uint256):(uint256,uint256,bytes32,uint32,bool,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GNS__legacySubgraphDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBytes(),
        value[3].toBigInt(),
  ...
  legacySubgraphKeys(param0: BigInt): GNS__legacySubgraphKeysResult {
    let result = super.call(
      "legacySubgraphKeys",
    ...
    return new GNS__legacySubgraphKeysResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_legacySubgraphKeys(
    param0: BigInt
  ): ethereum.CallResult<GNS__legacySubgraphKeysResult> {
    let result = super.tryCall(
      "legacySubgraphKeys",
      "legacySubgraphKeys(uint256):(address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GNS__legacySubgraphKeysResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  subgraphL2TransferData(param0: BigInt): GNS__subgraphL2TransferDataResult {
    let result = super.call(
    ...
    return new GNS__subgraphL2TransferDataResult(
      result[0].toBigInt(),
      result[1].toBoolean(),
      result[2].toBigInt()
    );
  ...
  try_subgraphL2TransferData(
    param0: BigInt
  ): ethereum.CallResult<GNS__subgraphL2TransferDataResult> {
    let result = super.tryCall(
      "subgraphL2TransferData",
      "subgraphL2TransferData(uint256):(uint256,bool,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GNS__subgraphL2TransferDataResult(
        value[0].toBigInt(),
        value[1].toBoolean(),
        value[2].toBigInt()
      )
  ...
  subgraphs(param0: BigInt): GNS__subgraphsResult {
    let result = super.call(
      "subgraphs",
    ...
    return new GNS__subgraphsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBytes(),
      result[3].toBigInt(),
  ...
  try_subgraphs(param0: BigInt): ethereum.CallResult<GNS__subgraphsResult> {
    let result = super.tryCall(
      "subgraphs",
      "subgraphs(uint256):(uint256,uint256,bytes32,uint32,bool,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
